function offsetplot(pn)
	...
	local bgalpha = 0.6
	local judgment = { -- Colors of each Judgment types
	...
	-- Background
	o[#o+1] = Def.Quad{InitCommand=cmd(zoomto,plotWidth+plotMargin,plotHeight+plotMargin;diffuse,bg;diffusealpha,bgalpha)}
