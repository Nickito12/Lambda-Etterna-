local t = Def.ActorFrame{	-- splashy thing when you first start a song
	...
	Def.Quad{
		Name="DestroyMe",
		InitCommand=cmd(xy,SCREEN_CENTER_X,SCREEN_CENTER_Y-40;zoomto,400,50;diffuse,JudgmentLineToColor("JudgmentLine_Held");fadeleft,0.4;faderight,0.4;diffusealpha,0),
